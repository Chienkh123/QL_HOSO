...
<div class="container-fluid">
    <div class="card shadow md-4">
        <div class="card-header py-3">
            <h6>
                <h3 class="m-0 font-weight-bold text-primary">Danh sách dân tộc</h3>
            </h6>
        </div>
        <div class="card-body">
            <form action="" method="post" class="mb-3">
                <div class="input-group col-md-6 mb-3" style="float: right;">
                    <select name="search_criteria" class="form-control col-md-3 form-select" style="margin-right: 10px; border-radius: 5px;">
                        <option value="madt">Mã dân tộc</option>
                        <option value="tendt">Tên dân tộc</option>
                    </select>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" width="100%" cellspacing="0" id="dataTable">
                        ...
                        $searchCriteria = $_POST['search_criteria'] ?? 'madt';

                        $sql = "SELECT * FROM hsdantoc WHERE $searchCriteria LIKE '%$searchValue%'";
                        ...
                        ?>
                                <tr class="text-center">
                                    ...
                                    <td><?= $row["tendt"] ?></td>
                                    <td>
                                        <a href="#" class="btn btn-success editDantoc" data-bs-toggle="modal" data-bs-target="#editmodal" data-madt="<?= $row['madt'] ?>"> <i class="bi bi-pencil-square" style="color: aliceblue;"></i></a>
                                        <a href="./controller/deleteDantoc.php?madt=<?= $row['madt'] ?>" class="btn btn-danger" onclick="confirmDelete(event)"> <i class="bi bi-trash3-fill" style="color: aliceblue;"></i></a>
                                    </td>
                                </tr>
                            <?php
                                $count++;
